...
from micro_kernel_SME.bf16_selector.tree import train_classification_tree, tree_depth, tree_leaf_count
...
def _emit_header(model: dict[str, dict[str, object]]) -> str:
    ...
    return (
        "/* Auto-generated by gemm/src/micro_kernel_SME/bf16_selector/emit_blas_small_selector.py */\n"
